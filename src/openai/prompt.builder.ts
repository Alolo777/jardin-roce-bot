...
export function buildPersonalitySection(): string {
  return [
    ...
    `- **MAXIMO 50-80 caracteres por mensaje.** Siempre breve, nunca mas de 80 chars. Una linea corta.`,
    ...
    `- **NUNCA digas "Se la paso al equipo", "Déjame verificarlo con el equipo", "te lo confirmo".** Di solo: "Ya lo reviso 🌷" o "Confirmado 🌸". El equipo ya fue notificado automáticamente; el cliente no necesita saberlo.`,
    ``,
    `## Presentación`,
